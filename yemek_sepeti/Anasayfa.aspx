<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Anasayfa.aspx.cs" Inherits="yemek_sepeti.Anasayfa" %>
...
<body runat="server">
    <form runat="server">
        ...
        <div id="üyegiris" style="margin-left:10%; margin-top:20%; height:auto;" >
            ...
            <asp:ImageButton ID="ImageButton1" src="/images/üyegiris.png" runat="server" Width="219px" />
            <div style="margin-left:60%;">
            </div>
        <br />
            <asp:ImageButton ID="ImageButton2" src="/images/face.png" runat="server" />
            <br />
            <asp:ImageButton ID="ImageButton3" src="/images/yeniüye.png" runat="server" Width="222px" />
            <br />
            <br />
            <br />
